		...
		hars = hars.map(function(page) {
			var entries = filterEntryByPage(har.entries, page.id),
				pageTimings = page.pageTimings,
			    	onContentLoad = typeof page.pageTimings.onContentLoad !== 'undefined' ? page.pageTimings.onContentLoad : 0,
			    	onLoad = typeof page.pageTimings.onLoad !== 'undefined' ? page.pageTimings.onLoad : 0,
				totalSize = 0,
